...
struct PulsRingsView5: View {
    ...
    // New tuning for disk pulse
    let diskPulseFrequency: Double = 3.0 // How many pulses during the growth phase
    let diskPulseScaleAmplitude: CGFloat = 0.03 // How much the disks scale up/down
    let diskPulseOpacityAmplitude: Double = 0.15 // How much the disks' opacity changes
                ...
                TimelineView(.animation) { ctx in
                    ...
                    ZStack {
                        ...
                        ForEach(0..<diskBaseSizes.count, id: \.self) { i in
                            ...
                            // Apply disk pulse to scale and opacity
...
struct PulsRingsView5_fixed_Previews: PreviewProvider {
